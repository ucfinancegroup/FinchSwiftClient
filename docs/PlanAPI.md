...
let planNewPayload = PlanNewPayload(name: "name_example", recurrings: [Recurring(id: MongoObjectID(oid: "oid_example"), name: "name_example", start: 123, end: 123, principal: 123, amount: 123, interest: 123, frequency: TimeInterval(typ: "typ_example", content: 123))], allocations: [Allocation(description: "description_example", date: 123, schema: [AllocationChange(asset: Asset(name: "name_example", _class: "_class_example", annualizedPerformance: 123), change: 123)])], events: [Event(name: "name_example", start: 123, transforms: [Transform(trigger: TimeInterval(typ: "typ_example", content: 123), changes: [AssetChange(asset: Asset(name: "name_example", _class: "_class_example", annualizedPerformance: 123), change: 123)])])]) // PlanNewPayload | 
